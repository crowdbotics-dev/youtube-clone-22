"""
Django settings for youtube_clone_22 project.
...
ROOT_URLCONF = 'youtube_clone_22.urls'
...
WSGI_APPLICATION = 'youtube_clone_22.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "youtube_clone_22 API",
    "DESCRIPTION": "API documentation for youtube_clone_22 App",
    "VERSION": "v1",
}
